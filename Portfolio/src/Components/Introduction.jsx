...
export default function Introduction() {
  ...
  return (
    <div className="block">
      <div className="mt-[20px] flex flex-col md:flex-row h-auto bg-body-yellow font-kreon items-center md:items-start justify-center md:justify-between space-y-8 md:space-y-0 md:space-x-8 px-4 py-6 md:py-8 lg:px-10 md:pt-[120px] md:pb-[120px] lg:pt-[130px] lg:pb-[170px]">
